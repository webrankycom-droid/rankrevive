...
export async function optimizeWithOpenAI(input: OptimizationInput): Promise<OptimizationResult> {
  ...
  const response = await client.chat.completions.create({
        ...
        messages: [
          {
                    role: 'system',
                    content: 'You are an expert SEO content strategist with 10+ years of experience helping websites recover lost rankings. You produce clean, semantic HTML wi
